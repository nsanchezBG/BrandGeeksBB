const CACHE_NAME = 'burger-run-cache-v10'; // Versión de caché incrementada
...
const urlsToCache = [
  ...
  '/BrandGeeksBB/player%20icono%20desktop.png', // El icono blanco de la PWA (ahora con contenido negro)
